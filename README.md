...
This required adjusting the scraper for the different template used for
STV elections. (As it's not clear what to take as the 'votes received'
in this sort of set-up, I've also just skipped that)
...
Then sent to QuickStatements as https://editgroups.toolforge.org/b/QSv2T/1597212099854/
